...
expandBtn?.addEventListener('click', () => detailsEls().forEach(d => (d.open = true)));
collapseBtn?.addEventListener('click', () => detailsEls().forEach(d => (d.open = false)));
...
const MODULE_INFO = {
  ...
  oop: {
    ...
    highlights: ["Refactored console apps using Strategy/Factory patterns.", "Applied SOLID basics to small projects."]
  },
  "found-comp": {
  ...
  hci: {
    ...
    desc: "UX research & design: heuristics, wireframes, accessibility, rapid prototyping and evaluation.",
    skills: ["UX", "Wireframing", "Accessibility", "Usability testing"],
    highlights: ["Ran quick user tests and iterated wireframes based on findings."]
  },
  cloud: {
    ...
    highlights: ["Deployed a tiny service to a free tier and documented steps."]
  },
  "db-web": {
  ...
  cibef: {
    ...
    highlights: ["Compared simple models and discussed bias/variance trade-offs."]
  },
  "comp-creativity": {
    ...
    highlights: ["Prototyped a small generative text/image tool and wrote criteria."]
  },
  "group-project": {
